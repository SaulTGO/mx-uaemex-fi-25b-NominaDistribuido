...
import mx.uaemex.fi.isii.api_backend.domain.entity.Usuario;
import mx.uaemex.fi.isii.api_backend.repository.EmpleadoRepository;
import mx.uaemex.fi.isii.api_backend.repository.UsuarioRepository;
import mx.uaemex.fi.isii.api_backend.util.Valid;
import mx.uaemex.fi.isii.api_backend.util.ValidateRegisterData;
 ...
 * @see mx.uaemex.fi.isii.api_backend.util.ValidateRegisterData
 */
@Service
